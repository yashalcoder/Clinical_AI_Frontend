...
export const metadata = {
  title: "Login",
  description: "Log in to your ClinicFlow AI Patient Portal to book appointments and access records."
};

export default function LoginPage() {
  const highlights = [
    "24/7 Smart Appointment Scheduling",
    "Instant Patient Intake & Consents",
    "Secure Access to Medical & Prescription Records",
    "Centralized Invoicing & One-Click Payments"
  ];
      ...
      <div className="relative md:w-1/2 bg-brand-primary text-white flex flex-col justify-between p-8 md:p-16 overflow-hidden">
        ...
        <div className="space-y-8 my-auto relative z-10 max-w-lg">
          <H2 className="text-white text-[30px] md:text-[36px] font-bold leading-tight !mb-0">
            The future of patient care experiences.
          </H2>
